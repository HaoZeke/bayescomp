...
for simple A-vs-B comparisons and
[`bc_fit_design()`](https://haozeke.github.io/bayescomp/reference/bc_fit_design.md)
for factorial designs — auto-detects the response family, sets weakly
...
- **Two entry points**:
  [`bc_fit()`](https://haozeke.github.io/bayescomp/reference/bc_fit.md)
  for the common case (method as factor),
  [`bc_fit_design()`](https://haozeke.github.io/bayescomp/reference/bc_fit_design.md)
  for full
...
- **Pairwise contrasts**:
  ...
  wraps `marginaleffects` for \>2 method comparisons
- **Simulation**:
  [`bc_simulate_benchmark()`](https://haozeke.github.io/bayescomp/reference/bc_simulate_benchmark.md)
  for power analysis and parameter recovery testing
- **Over 40 exported functions** covering data ingestion, validation,
  model fitting, diagnostics, effect extraction, and visualization
