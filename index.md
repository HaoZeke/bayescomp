...
bayescomp requires a working [cmdstanr](https://mc-stan.org/cmdstanr/)
installation for model fitting.
...
5.  **Generates plots**: conditional effects, posterior predictive
    checks, Pareto-k diagnostics, dumbbell comparisons, performance
    profiles
...
- **One-call workflow**:
  `bc_read_benchmark() |> bc_pivot_long() |> bc_fit()`
- **targets integration**: every pipeline stage is independently
  cacheable

## Vignettes

- [Getting
  Started](https://haozeke.github.io/bayescomp/vignettes/bayescomp.Rmd)
- [NEB Case
  Study](https://haozeke.github.io/bayescomp/vignettes/neb-case-study.Rmd)
- [Dimer Rotation Case
  Study](https://haozeke.github.io/bayescomp/vignettes/dimer-case-study.Rmd)
- [Model Selection
  Guide](https://haozeke.github.io/bayescomp/vignettes/model-selection.Rmd)
